...
> 🌐 [中文](https://www.byolio.blog/2024-11-30-CppReference/) | [English](https://www.byolio.blog/en/en/_posts/2024-11-30-CppReference/)
...
```
Simply put, lvalues can be assigned, while rvalues cannot be assigned (i.e., the left side of = is an lvalue, and the right side of = is an rvalue).
