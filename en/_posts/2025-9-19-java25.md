...
> 🌐 [中文](/2025-9-19-java25/) | [English](/en/en/_posts/2025-9-19-java25/)
...
> Java 25 documentation download link: [https://www.oracle.com/java/technologies/javase-jdk25-doc-downloads.html](https://www.oracle.com/java/technologies/javase-jdk25-doc-downloads.html)

## Introduction
On September 16, another TLS version, Java 25, was released after Java 21, bringing with it a large number of new features. Below is a brief overview of some of the new features in Java 25.
...
2. -XX:+UseCompactObjectHeaders becomes a formal product option
...
### Tools
1. jar --validate enhanced validation (duplicate entries, illegal paths, LOC/CEN inconsistencies, etc.)

## Java 25 Preview/Incubating Features
1. JEP 502: Stable Values (Preview)
2. JEP 505: Structured Concurrency (Fifth Preview)
3. JEP 506: Scoped Values (Formal? → Needs confirmation: Standardized in Java 25, preview in Java 24)
...
### hotspot / runtime
    Removal of PerfData sampling functionality
    Removed StatSampler
...
### security-libs / javax.crypto:pkcs11
    Removal of SunPKCS11 Provider's PBE SecretKeyFactory implementations
    ...
    Alternative: Use corresponding SunJCE implementations

### Other
    Official announcement and OpenJDK release notes state that Java 25 officially "drops 32-bit support for x86", and will no longer support x86 32-bit platforms.
