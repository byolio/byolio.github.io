...
## Introduction
With the explosive popularity of the world's first general-purpose AI agent [Manus](https://manus.im/) last week, its invitation codes became extremely hard to obtain. Therefore, five experts replicated an open-source general-purpose AI agent in just three hours, naming it OpenManus, hoping to help more people use general-purpose agents. In this chapter, I will introduce the deployment and usage of OpenManus.
...
```
Once downloaded, enter the following command to install OpenManus's conda dependencies:
```cmd
cd OpenManus
...
Note: During use, OpenManus may invoke the browser and pop up web pages. This is normal for an AI agent searching for information. Please do not close the web pages, as this may cause OpenManus to skip the information being searched.
