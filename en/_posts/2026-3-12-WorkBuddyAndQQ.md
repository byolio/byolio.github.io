...
> 🌐 [中文](https://www.byolio.blog/2026-3-12-WorkBuddyAndQQ/) | [English](https://www.byolio.blog/en/en/_posts/2026-3-12-WorkBuddyAndQQ/)
...
Follow the installation wizard by clicking "Next" all the way.
...
Scan the QR code to log in, and you will be automatically redirected to create an admin account (if you haven't used this platform before). In this step, select the current logged-in account as the admin, enter your ID number and name, etc., and then create a bot on this page, as shown:
![QQ Platform](https://cdn.jsdelivr.net/gh/byolio/tc3@main/img/QQpingtai.png)

### 3. Obtain Bot Information
Get the AppID and AppSecret of the created bot. Remember these two pieces of information, as they will be used in WorkBuddy.
...
Below, it will show "Registration successful", and then a callback URL (a string of web address) will appear. Click to copy this URL.

### 5. Configure QQ Open Platform
On the QQ Open Platform, fill in the callback URL in the "Request URL" field of the callback configuration. For the events below, it is recommended to check all chat-related ones (after configuration, be sure to click "Confirm Configuration", otherwise the configuration will not take effect), as shown:
