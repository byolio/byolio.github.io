...
> 🌐 [中文](/2025-1-28-DockerDeepseekR1/) | [English](/en/en/_posts/2025-1-28-DockerDeepseekR1/)
...
It can be seen that it has capabilities comparable to ChatGPT-o1 in multiple fields, with performance on par with the official OpenAI o1 in tasks such as mathematics, code, and natural language reasoning. Therefore, we can deploy it on a computer using Docker as a personal LLM assistant.
...
Currently, laptop GPUs are mainly NVIDIA RTX 4060 and RTX 4070. The 50 series has not yet been widely adopted for laptops, and the VRAM is primarily 8GB. You can install the deepseek-R1:7b or 8b version. For lower VRAM, it is recommended to install the deepseek-R1:1.5b version.
...
Click the option to pull from Ollama.com to automatically complete the download.
### page assist
