...
> 🌐 [中文](/2025-4-26-hadoopMapReduce/) | [English](/en/en/_posts/2025-4-26-hadoopMapReduce/)
...
## Introduction
After starting the Hadoop cluster as described earlier, we can begin writing MapReduce tasks. This article mainly explains how to import a project and its dependencies via IDEA, upload the JAR file to Linux, and execute MapReduce tasks on Hadoop.
...
Then, a JAR file will be generated in the `artifacts` directory under the `out` directory. You can upload this JAR file to Linux via Xftp.
...
## View Output Results
Open the MapReduce web UI to see the historical execution records of MapReduce, which can confirm whether the task was executed successfully, along with execution time and other information.
...
### What if the JAR file is not generated or is accidentally deleted?
